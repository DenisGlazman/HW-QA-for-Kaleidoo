...
@allure.title("Create and publish new real estate ad with all fields")
def test_create_new_ad(page: Page):
    ...
    with allure.step("Fill in ad details"):
        try:
            new_ad_page.fill_ad_details()
            new_ad_page.fill_additional_details()
            ...
            new_ad_page.fill_payment_details()
